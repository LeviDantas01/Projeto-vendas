 ...
 * {@link WebServiceCep#searchCep(String)} para
 * maiores informa��es.
 * <BR>
 * <BR>
 ...
 * <BR>
 * <BR>
 * Objeto contem todas as informa��es do XML, al�m de informa��es referente ao
...
public final class WebServiceCep {
	...
	/**
	 * Classe utilit�ria apenas encapsula o Iterator de elements da root dentro de
	 * um
	...
	/**
	 * Mascara para a string url de conex�o, onde <tt>"%s"</tt> � substituido pelo
	 * valor
	 * do cep.
	 */
	 ...
	 * <tt>{@link Iterable}<{@link Element}></tt> podendo ser recuperados um a um
	 * dentro
	 * de um for
	 * <BR>
	 * <BR>
	 ...
	 * <tt>"14568910"</tt>.
	 * <BR>
	 * Uma <tt>{@link String} "1%4#5?55%16a8&910"</tt> � automaticamente passada
	 * para
	 * <tt>"14555168"</tt>, s� levando em conta os primeiros 8 n�meros.
	 * 
	 * @param cep N�mero do cep a ser carregado. S� ser�o considerados os primeiros
	 *            8
	 *            n�meros da {@link String} enviada. Todos os caracters n�o
	 *            num�ricos ser�o
	 *            removidos, e a string ser� truncada caso seja maior que 8
	 *            caracters.
	...
	private static int resulCode = -1;
	...
	private void setResulCode(int resultado) {
		WebServiceCep.resulCode = resultado;
	}
	 ...
	 * C�digos conhecidos:
	 * <BR>
	 * <tt>-1</tt> : busca n�o realizada
	 * <BR>
	 * <tt>0</tt> : cep n�o encontrado
	 * <BR>
	 * <tt>1</tt> : cep econtrado
	 * <BR>
	 * <tt>-14</tt> : Site n�o encontrado (pode ser por problemas na internet).
	 * <BR>
	 * <tt>-15</tt> : N�o foi possivel ler o documento xml
	 * <BR>
	 * <tt>-16</tt> : Erro na forma��o da url
	 * <BR>
